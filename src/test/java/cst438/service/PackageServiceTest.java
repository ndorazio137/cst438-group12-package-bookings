...
public class PackageServiceTest {
    ...
    * Create TripInfo Object String startingCity = "startingCity"; String
    * destinationCity = "DestinationCity"; Date randomDepartureDate = new
    * Date(1995, 11, 17); Date randomArrivalDate = new Date(1995, 11, 17);
    ...
    * 
    * // Define some trip info String startingCity = "Chicago"; String
    * destinationCity = "Miami"; Date departureDate = new Date(1995, 11, 17);
    * Date arrivalDate = new Date(1995, 11, 17); // Set up the helper object to
    * store our trip info
    * 
    * TripInfo tripInfo = new TripInfo(startingCity, destinationCity,
    ...
    * 
    * // Have the package service use our trip info to generate a list of
    * packages List<Package> actualPackageList =
    * packageService.getPackageList(tripInfo);
    * 
    * // Generate the expected output, an empty list List<Package>
    * expectedPackageList = new ArrayList<Package>();
    * 
    ...
    * Create TripInfo Object String startingCity = "Chicago"; String
    * destinationCity = "Miami"; Date departureDate = new Date(1995, 11, 17);
    * Date arrivalDate = new Date(1995, 11, 17); TripInfo tripInfo = new
    * TripInfo(startingCity, destinationCity, departureDate, arrivalDate);
    * 
    ...
    * 
    * // this service will return a list of size > 0 ArrayList<Object> hotelList
    ...
    * 
    * // this service will return a list of size > 0 ArrayList<Object>
    * flightList = new ArrayList<Object>(); flightList.add("Allegiant");
    ...
    * packageService.getPackageList(tripInfo);
    * 
    * // Generate the expected output, a null value List<Package>
    * expectedPackageList = null;
    * 
    * // Check if actual result matches expected result
    ...
    * TripInfo(startingCity, destinationCity, departureDate, arrivalDate);
    * 
    * // this service will return a list of size > 0 ArrayList<Object> carList =
    * new ArrayList<Object>(); carList.add("Ford Fusion");
    * carList.add("Honda CR-V"); carList.add("Toyota Camry");
    * given(carService.getAvailableCars(destinationCity, departureDate,
    * arrivalDate)).willReturn(carList);
    * 
    * // this service will return a null value
    ...
    * 
    * @Test public void testAllGoodResponses() throws Exception { // Create
    * TripInfo Object String startingCity = "Chicago"; String destinationCity =
    * "Miami"; Date departureDate = new Date(1995, 11, 17); Date arrivalDate =
    * new Date(1995, 11, 18);
    * 
    * TripInfo tripInfo = new TripInfo(startingCity, destinationCity,
    * departureDate, arrivalDate);
    * 
    * // this service will return a list of size > 0 List<Object> carList = new
    * ArrayList<Object>(); carList.add("Ford Fusion");
    * carList.add("Honda CR-V"); carList.add("Toyota Camry");
    * given(carService.getAvailableCars(destinationCity, departureDate,
    * arrivalDate)).willReturn(carList);
    * 
    * // this service will return a list of size > 0 List<Object> hotelList =
    * new ArrayList<Object>(); hotelList.add("Sheraton");
    * hotelList.add("Motel 6"); hotelList.add("Best Western");
    * hotelList.add("Hilton");
    * given(hotelService.getAvailableHotels(destinationCity,
    * arrivalDate)).willReturn(hotelList);
    * 
    * // this service will return a list of size > 0 List<Object> flightList =
    ...
    * packageService.getPackageList(tripInfo);
    * 
    * // Generate the expected output List<Package> expectedPackageList = new
    * ArrayList<Package>(); expectedPackageList.add(new Package(carList.get(0),
    * hotelList.get(0), flightList.get(0))); expectedPackageList.add(new
    * Package(carList.get(1), hotelList.get(1), flightList.get(1)));
    * 
    * // Check if actual result matches expected result
    * assertThat(actualPackageList).isEqualTo(expectedPackageList); }
    */
